...
var CACHE_NAME = "hive_cache";
export function isExpired(url) {
    var val = localStorage.getItem(url);
    if (!val || val.length === 0)
        return false;
    var expiration = parseInt(val, 10);
    if (Date.now() >= expiration)
        return true;
    return false;
}
export function putCache(buf, url) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, localStorage.setItem(url + "ca", Buffer.from(buf).toString("base64"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function getCache(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            s = localStorage.getItem(url + "ca");
            //console.log(s)
            if (!s)
                return [2 /*return*/, null];
            res = Buffer.from(s, "base64");
